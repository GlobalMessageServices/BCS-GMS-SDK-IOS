...
extension FbClass2: UNUserNotificationCenterDelegate{
    public func userNotificationCenter(_ center: UNUserNotificationCenter,
        ...
        let deliver_report = SKrest.init()
        deliver_report.sk_message_dr(message_Id: userInfo[gcmMessageIDKey] as! String, received_At: userInfo["google.c.a.ts"] as! String, X_Hyber_Session_Id: userInfo["google.c.a.c_id"] as! String, X_Hyber_Auth_Token: token111)
