...
Pod::Spec.new do |spec|
  ...
  This is SDK for Push messages. This SDK is for communication web service API only.
                   DESC
  ...
  spec.author             = { "Push" => "kir.kotov5@gmail.com" }
  ...
  spec.source       = { :git => "https://github.com/kirillkotov/Push-SDK-IOS.git", :tag => "#{spec.version}" }
  ...
  spec.source_files  = "Classes", "Classes/**/*.{h,m}", "PushSDK/*.{h,m}", "PushSDK", "PushSDK/api", "PushSDK/core", "PushSDK/settings" #, "PushSDK/notifications"
  ...
  #  core.xcconfig = { 'HEADER_SEARCH_PATHS' => '$(PODS_ROOT)/PushSDK/FirebaseCore' }
  #end
