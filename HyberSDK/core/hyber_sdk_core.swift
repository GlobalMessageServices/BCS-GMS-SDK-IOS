...
class ViewController2: UIViewController {
    ...
    func createData(){
        ...
        let userEntity = NSEntityDescription.entity(forEntityName: "HyberSDK_mess", in: managedContext)!
    ...
    func retrieveData() {
        ...
        let fetchRequest = NSFetchRequest<NSFetchRequestResult>(entityName: "HyberSDK_mess")
