...
public class HyberAppDelegatePush: UIResponder, UIApplicationDelegate {
    //open class HyberAppDelegatePush: UIApplication {
    let processor = Processing.init()
    let hyber_adapter = HyberSDK.init(user_msisdn: Constants.hyber_user_msisdn, user_password: Constants.hyber_user_password)
    ...
    public func application(_ application: UIApplication, didReceiveRemoteNotification userInfo: [AnyHashable: Any],
        ...
        hyber_adapter.hyber_message_delivery_report(message_id: new3String)
